    ...
    <div id={props.articleId} className="article-item col s12 l6">
        <div className="card">
            <div className="card-content">
                ...
                <div className="row">
                    <div className="view col s12 l6">
                        <Link to={props.articleUrl} target="_blank"><i className="material-icons tiny">call_made</i>View Article</Link>
                    </div>
            ...
            <div className="card-action">
                {props.saveArticle ?  <Link to="#" className="btn-unsave" onClick={() => props.saveArticle(props.articleTitle, props.articleDate, props.articleUrl)}> <i className="material-icons tiny">save</i>Save Article</Link> : null}
